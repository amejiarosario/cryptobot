...
describe('Ticker', function () {
  ...
  xdescribe('Save data by minute/pair/provider', () => {
    const provider = {
    ...
    it('should save ticks by products', done => {
      dbMock.expects('collection').once().withArgs('gdax.BTC-USD.aggreagete.minute').returns(collection);
