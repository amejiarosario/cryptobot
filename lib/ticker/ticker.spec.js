...
describe('Ticker', function () {
  const collection = { insertMany: () => { }, updateOne: ()=>{}, find: () => {} };
      ...
      ticker(provider).subscribe(
        data => {
          ...
          if(count > 3) {
            ...
            sinon.assert.calledWithExactly(collection.insertMany, [
              { price: 2345.02, side: "buy", size: 0.01, time: "2017-08-04T20:12:16.277Z" },
              { price: 2550, side: "buy", size: 0.01, time: "2017-08-04T20:12:16.277Z" }]);
  ...
  describe('Storage optimizations', () => {
    it('should avoid duplicated orders')
    it('should storage using upsert aggregated by minute')
  });
