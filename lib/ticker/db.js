...
function updateAggregatedData(productId, data) {
  ...
  return co(function* updateAggregatedDataGen() {
    ...
    for (const time of Object.keys(TIMES)) {
      ...
      debug(`${productId} bulk operation %o`, { nUpserted, modifiedCount, r }, '[verbose]'); // too many
    }
...
function saveTrade(data) {
  ...
  return co(function*(){
    ...
    debug(`Orders operation saved %o`, { nUpserted, modifiedCount, results });
...
function updateSingleOrder(order) {
  return co(function *() {
    ...
    const { nUpserted, modifiedCount } = r;
    debug(`Updating order %o`, { nUpserted, modifiedCount, r });
    db.close();
    return r;
  });
}
...
function saveOrders(data) {
  ...
  return co(function* () {
    ...
    const { nUpserted, modifiedCount } = r;
    debug(`Orders operation saved %o`, { nUpserted, modifiedCount, r }); // too many
