...
// /ohlc?limit=200
d3.json("/ohlc?limit=600&tickerId=gdax.btc-usd&resolution=days", function (error, data) {
  ...
  var trendlineData = [
    // { start: { date: new Date(2017, 7, 10), value: 2072.50 }, end: { date: new Date(2014, 5, 9), value: 63.34 } },
    // { start: { date: new Date(2017, 9, 21), value: 4003 }, end: { date: new Date(2014, 2, 17), value: 70.50 } }
  ];
