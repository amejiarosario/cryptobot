...
describe('Weekly close diff strategy simulator', function () {
  ...
  beforeEach(done => {
    const timeFilter = { $match: { timestamp: {
      ...
      // $gte: new Date("2017-08-28T20:00:00.000Z"), // works!
      // $lt: new Date("2017-09-28T22:02:00.000Z")

      $gte: new Date("2017-08-10T00:00:00.000Z"),
      $lt: new Date("2017-08-25T00:00:00.000Z") // only 14 days
      // $lt: new Date("2017-09-10T00:00:00.000Z") // 1 month
    } } };
