 ...
 *
 * $ lsof -i -n -P | grep LISTEN | grep 5100 | awk 'NR==1 {print $2}' | xargs kill
 */
...
describe('Weekly close diff strategy simulator', function () {
  ...
  beforeEach(done => {
    const timeFilter = { $match: { timestamp: {
      $gte: new Date("2017-09-27T21:58:00.000Z"), // +27s
      $lt: new Date("2017-09-28T22:00:00.000Z")
    } } };
