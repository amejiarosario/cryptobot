...
describe('Trailing Price', function() {
  ...
  describe('#sell', () => {
    describe('when trailing is percentage and amount and trade has no amount', () => {
      ...
      it('should never reduce the sell price', () => {
        ...
        to.setPrice(1515);
        expect(to.orders[0].trigger.sell.price).to.equal(1499.85);
        expect(to.orders[0].trigger.sell.trail).to.equal(1530.15);
  ...
  describe('#buy', () => {
    describe('when trailing is an amount and trade is an amount and percentage', () => {
      ...
      it('should never increase the buying price', () => {
        ...
        to.setPrice(1850);
        expect(to.orders[0].trigger.buy.price).to.equal(1900);
        expect(to.orders[0].trigger.buy.trail).to.equal(1800);
  ...
  describe.only('# trade issues', () => {
    ...
    it('should not do multiple trades', done => {
      let trades = 0;
      to.on('trade', () => {
        trades++;
      });
    ...
    it('should avoid size too precise', () =>{
